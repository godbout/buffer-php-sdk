...
class Client
{
    ...
    public function updateProfileSchedules($id, $schedules)
    {
        ...
        return $this->send(
            $this->getHttp()->post($this->url . 'profiles/' . $id . '/schedules/update.json', null, $payload)
        );
    }
    ...
    public function reorderProfileUpdates($id, $order, $offset = null, $utc = false)
    {
        ...
        return $this->send(
            $this->getHttp()->post($this->url . 'profiles/' . $id . '/updates/reorder.json', null, $payload)
        );
    }
    ...
    public function shuffleProfileUpdates($id, $count = null, $utc = false)
    {
        ...
        return $this->send(
            $this->getHttp()->post($this->url . 'profiles/' . $id . '/updates/shuffle.json', null, $payload)
        );
    }
    ...
    public function createUpdate(Update $update)
    {
        ...
        return $this->send(
            $this->getHttp()->post($this->url . 'updates/create.json', ['form_params' => $payload])
        );
    }
    ...
    {
        $payload = http_build_query(['url' => $url]);
